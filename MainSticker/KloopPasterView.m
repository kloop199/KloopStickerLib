...
@implementation KloopPasterView
...
- (UIImageView *)btSizeCtrl
{
    if (!_btSizeCtrl)
    {
        ...
        NSString *path = [[NSBundle mainBundle] pathForResource:@"旋转" ofType:@"png"];
        NSData *data = [NSData dataWithContentsOfFile:path];
        _btSizeCtrl.image = [UIImage imageWithData:data] ;
...
- (UIImageView *)btDelete
{
    if (!_btDelete)
    {
        ...
        NSString *path = [[NSBundle mainBundle] pathForResource:@"删除" ofType:@"png"];
               NSData *data = [NSData dataWithContentsOfFile:path];
               _btDelete.image = [UIImage imageWithData:data] ;
