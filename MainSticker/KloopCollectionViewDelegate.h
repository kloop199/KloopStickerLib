...
@class KloopPiecesStatus;
typedef void (^selectCell) (NSIndexPath *indexPath);
@interface KloopCollectionViewDelegate : NSObject<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>

@property (nonatomic, strong) KloopPiecesStatus *status;
