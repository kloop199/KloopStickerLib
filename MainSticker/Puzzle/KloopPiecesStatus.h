...
#import "KloopPathSearcher.h"
#import "KloopStarSearcher.h"
#import "KloopSquareModel.h"

/// 表示游戏过程中，某一个时刻，所有方块的排列状态
@interface KloopPiecesStatus : NSObject <KloopPathSearcherStatus, KloopStarSearcherStatus>
/// 矩阵行数
...
@property (nonatomic, strong) NSMutableArray<KloopSquareModel *> *pieceArrayModel;
