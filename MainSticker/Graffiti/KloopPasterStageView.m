...
@interface KloopPasterStageView () <KloopPasterViewDelegate>
{
    CGPoint         startPoint ;
    CGPoint         touchPoint ;
...
@property (nonatomic,strong) KloopPasterView   *pasterCurrent ;
@property (nonatomic)        int            newPasterID ;

@end

@implementation KloopPasterStageView
...
- (void)setPasterCurrent:(KloopPasterView *)pasterCurrent
{
...
- (void)addPasterWithImg:(UIImage *)imgP
{
    ...
    self.pasterCurrent = [[KloopPasterView alloc] initWithBgView:self
...
- (void)clearAllOnFirst
{
    ...
    [m_listPaster enumerateObjectsUsingBlock:^(KloopPasterView *pasterV, NSUInteger idx, BOOL * _Nonnull stop) {
