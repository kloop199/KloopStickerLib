...
@implementation KloopPathSearcher
...
- (void)setStartStatus:(id<KloopPathSearcherStatus>)startStatus {
    // 保证开始状态是没有父状态的。为了保证在构建路径的时候不会超出开始状态。
    [startStatus setParentStatus:nil];
    _startStatus = startStatus;
}

- (void)setTargetStatus:(id<KloopPathSearcherStatus>)targetStatus {
